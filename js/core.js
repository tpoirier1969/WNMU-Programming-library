...
const els = {
  ...
  rightsWindowStartFilter: $('#rightsWindowStartFilter'),
  rightsWindowEndFilter: $('#rightsWindowEndFilter'),
  clearRightsWindowFilter: $('#clearRightsWindowFilter'),
  setRightsWindowMonthBtn: $('#setRightsWindowMonthBtn'),
