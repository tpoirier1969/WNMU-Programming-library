// v1.5.103 Library filter layout hardening + secondary-topic narrowing
// Replaces the earlier helper in the same file path and pairs with the v1.5.103 cache-buster.
// This intentionally overrides older CSS and inline grid styles injected by library-workflow.js.

(function () {
  const VERSION = 'v1.5.103 library filter layout hardening';
