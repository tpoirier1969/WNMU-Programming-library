// v1.5.98 Main Library UI polish
// Keeps this rollup at v1.5.98 while tightening the topbar and moving Quick Air Dates
// beside the rating stars in the program list.

(function () {
  const VERSION = 'v1.5.98 main library UI polish';

  function injectStyles() {
    if (document.getElementById('wnmuMainLibraryUiV1598Styles')) return;
    const style = document.createElement('style');
    style.id = 'wnmuMainLibraryUiV1598Styles';
    style.textContent = `
      #appShell .topbar {
  ...
  function patchRenderTable() {
    if (window.__wnmuMainUiV1598RenderPatch) return;
    window.__wnmuMainUiV1598RenderPatch = true;
