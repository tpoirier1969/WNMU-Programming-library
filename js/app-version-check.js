// v1.5.107 App version check / Pledge-style manifest gate
...
(function () {
  const APP_VERSION = String(window.WNMU_APP_VERSION || 'v1.5.107');
  ...
  const STYLE_ID = 'appVersionGateStylesV15107';
