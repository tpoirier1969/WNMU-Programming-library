// v1.5.99 Main Library UI polish
// Keeps the v1.5.98 version-check rollup, fixes the visible version flag,
// moves Quick Air Dates beside the rating stars, and removes description Copy buttons.

(function () {
  const VERSION = 'v1.5.99 main library UI polish';

  function injectStyles() {
    if (document.getElementById('wnmuMainLibraryUiV1599Styles')) return;
    const style = document.createElement('style');
    style.id = 'wnmuMainLibraryUiV1599Styles';
    style.textContent = `
      #appShell .topbar {
